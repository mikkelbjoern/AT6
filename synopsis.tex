...
Laplace argumenterede for, at denne dæmon måtte kende alt fremtid og alt fortid, hvis den ellers var i stand til at kigge på alt dette data. 
...
Det skulle vise sig, at deterministisk kaos var et argument for, at mennesker aldrig i praksis ville kunne få den samme viden som Laplace' dæmon.
...
Det lykkedes ham til gengæld ikke at gøre det samme med tre legemer, og han opstiller det derfor som et problem, som andre kan arbejde videre med. 
...
Algoritmen er beskrevet i et forsimplet flowchart, som er vedlagt.
...
I bilaget ses min sourcekode sammen med et link til GitHub, hvor jeg løbende opdaterer koden op til eksamen, hvis jeg finder eventuelle småfejl, eller der er noget æstetisk, som jeg vil ændre på. 
...
En kritiker kunne så spørge, hvorfor kaos overhovedet er relevant, når nu vi kan forudsige nogen ting. 
...
Fænomenet opstår mange steder, specielt vigtigt er det at det opstår mange stedet i naturen. 
...
Dette passer ikke umiddelbart med den intuition, som man længe har haft for naturvidenskaben. 
...
\begin{itemize}
	...
	\item A philosophical essay on probabilities, Pierre Simon, Marquis de Laplace\\
...
\begin{itemize}
	...
	\item Screencast af simulationen:\\
	\url{https://www.youtube.com/watch?v=7wqqHaAeYVE&feature=youtu.be&hd=1}
